...
public class FilRun {
	public static void main(String[] args) {
		...
		try {
			...
			//2.  경로를 지정하고 파일 생성
			File file2 = new File("C:/aaa/test.text");
			file2.createNewFile();
			
			//3. 폴더만 생성하기
			File bbbFolder = new File("C:/bbb"); 
			bbbFolder.mkdir(); // makeDirectory(폴더 만들기)
			//하나에 폴더만 만들기
			
			//4. 폴더 여러개 만들기
			File cccdddFolder = new File("C:/ccc/ddd");
			cccdddFolder.mkdirs(); // 여러개 제작 가능
			...
			System.out.println("파일용량 : " + file2.length());
			System.out.println("정대경로 : " + file1.getAbsolutePath());
