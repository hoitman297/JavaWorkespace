...
import com.kh.chap01_innerClass_part02_static.model.vo.Member;
...
//		InnerClass ic = oc.new InnerClass();
		...
		// 빌더클래스를 활용한 객체 생성
		Member m = new Member.Builder().id("hoitman297").name("명지원").age(32).build();
		...
		/*
		 	...
		 	- vo 클래스에 setter메서드가 존재하지 않음으로써 불변성 유지가 가능
