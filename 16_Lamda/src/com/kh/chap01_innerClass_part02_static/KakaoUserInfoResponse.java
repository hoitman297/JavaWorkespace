...
public class KakaoUserInfoResponse {
	/*
	 	...
	 	- VO클래스와 다르게 데이터의 "송/수신"이 주 목적이기 때문에 불필요한 메서드들이 존재하지 않는다(equals,hashcode, setter...)
	 	- api 서버들에는 다양한 서비스들이 존재하며, 각 서비스마자 요구하는 데이터의 형식 및
	 		반환되는 응답의 형식이 다양하기 때문에 이에 맞춰서 DTO클래스를 설계시 굉장히 많은 양의 클래스들이 나온다.
	 	- 이렇게 너무 많은 DTO 클래스가 파일로 존재하면 관리가 힘들어지므로 필요한 클래스들을 하나의 파일로
	 		모아서 관리하는게 일반적이다.
	...
	private KakaoAccount kakaoaccuount;
