...
public class D_StringMethod {
	public void method() {
		...
		//함수형 프로그래밍을 위해 준비된 메서드
		String str2 = str1.concat("!!!");
		System.out.println("str2 : " + str2);
		
		//4. 문자열.substring(int beginIndex) : String
		//	- 문자열의 시작인덱스위치부터 끝까지의 문자열을 추출하여 리턴
		//	문자열.substring(int beginIndex, int denIndex) : String
		//	- 문자열의 시작인덱스부터 종료 인덱스까지 () 의 문자열을 추출하여 리턴
		//"World"
		System.out.println(str1.substring(6));	//6번 인덱스부터 끝까지
		
		//"Hello"
		System.out.println(str1.substring(0,5)); // 0번 인덱스부터 5번까지(4번인덱스)
		...
		// 9. static valueOf(다양한 자로형) : String
	...
	public static void main(String[] args) {
		D_StringMethod method = new D_StringMethod();
		method.method();
	}
}
