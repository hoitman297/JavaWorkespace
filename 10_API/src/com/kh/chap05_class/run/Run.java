...
public class Run {
	...
	public void test1() throws ClassNotFoundException, IllegalAccessException, InstantiationException	{
		...
		/*
		 	...
		 	Class 클래스를 이용하여 클래스의 정보를 가져오고, 생성자나 메서드를 활용하여 객체를 생성하고, 메소드를 
		 	호출하는 방식의 프로그래밍	
		 	
		 	보통 프로그램이 실행중일때, 객체의 타입을 직접 알 수 없는 경우 Class를 통해 객체를 생성하고, 객체내부의
		 	메타데이터를 수집하기 위해 사용한다.
		 	
		 	이를 통해 프레임워크에서는 어노테이션을 이용한 자동화 구조를 설계하였다.
		 */
	}
	...
	public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		/*
		 	Class
		 	 - 자바의 모든 클래스와 인터페이스는 컴파일 완료된 후 class 파일로 생성된다.
		 	 - Class클래스는 이 class 자체의 정보를 가져올때 사용한다.
