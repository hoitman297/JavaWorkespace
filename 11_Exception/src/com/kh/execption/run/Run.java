	...
	public static void main(String[] args) throws C_CustomExecption {
		/*
			에러(오류) 종류
				...
				- 논리 에러
						- 소스코드상의 문법적인 문제도 없고, 실행시 에러도 없지만, 프로그램의 의도와 다른 결과를 반환하는 에러
		 		
		 		예외처리
		 				- 위와 같은 예외들이 발생했을 경우를 대비하여 처리하는 방법을 사전에 정의해두는 것을 "예외처리"라고 한다.
		 				- 예외처리를 하지 않으면 프로그램 실행중 예외(오류) 가 발생하는 경우 프로그램이 작동 중지 한다.
		 */
