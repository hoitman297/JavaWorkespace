...
public class Run {
	public static void main(String[] args) {
		/*
		 	...
		 	- 만약, 스레드간에 우선순위가 부여도니 경우, 우선순위가 높은 스레드가 더 많은 작업시간을 할당받는다. (우선순위 기반 스케쥴링)
		 	- 스레드간의 우선순위가 동일한 경우 동일한 시간 할당량이 주어진다.
		 	- Round Robin은 os가 정하는 스레드 스케줄링 방식으로, 소스코드로 제어가 불가능하다.
